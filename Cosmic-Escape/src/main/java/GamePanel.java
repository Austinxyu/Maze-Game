...
public class GamePanel extends JPanel{
    ...
    /**
     * Draws the items for the game Win screen
     * @param g Graphics object for drawing in the screen
     */
    ...
    /**
     * Draws the items for the Game Start screen
     * @param g Graphics object for drawing in the screen
     */
    ...
    /**
     * Draws the items for the Game over screen
     * @param g Graphics object for drawing in the screen
     */
    ...
    /**
     * Draws the items for the playing game state
     * @param g Graphics object for drawing in the screen
     */
